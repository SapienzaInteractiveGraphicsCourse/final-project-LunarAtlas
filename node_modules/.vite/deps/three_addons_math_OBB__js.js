import { $r as MathUtils, Bs as Vector3, U as Box3, lo as Ray, ni as Matrix4, ti as Matrix3 } from "./three.module-Dhi4sXJn.js";
...
var OBB = class {
	...
	*/
	intersectRay(ray, target) {
		...
		if (localRay.intersectBox(aabb, target)) return target.applyMatrix4(matrix);
		else return null;
	}
	/**
	...
	*/
	fromBox3(box3) {
		...
		box3.getSize(this.halfSize).multiplyScalar(.5);
